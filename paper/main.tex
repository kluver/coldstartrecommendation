...
%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{table}[ht!]
    ...
    \begin{tabular}{|p{7em}|p{16em}|}
      ...
      Spread@20              & The entropy of the distribution of recommended items for users in the test set.\\\hline
    \end{tabular}
    \caption{TODO:}
    \label{tbl:metrics}
  \end{table}
...
%This is simply a rescaling of the ILS metric from \cite{ziegler}. Similarity is computed by subtracting the average item rating from the item vectors for each item and then computing the cosine similarity.\\\hline
